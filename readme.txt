...
・ Fortschritt für die Defragmentierung wird jetzt angezeigt,
  ...
  Neustart Funktion hinzugefügt. (v. 1.1 / 24.11.2024)
・ Versionshistorie erstellt. (v. 1.0 / 22.11.2024)

Diese Batch Datei führt eine Bereinigung des Computers durch mit Hauseigenen Windows Tools per Befehls-Skript.

1. Entpacke die: "TuneUp.bat" aus dem WinRAR-Archiv.
2. Führe die: "TuneUp.bat" als Administrator aus.
3. Folge den Anweisungen in der Kommandozeile.
